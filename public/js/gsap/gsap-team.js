...
const radiusX = 40;    // vw half-width of your arc
const radiusY = 25;    // vh height of the arch
const pullIn  = 7.5;   // optional: brings 2nd & 4th cards in
const hoverDist = 50;  // px to push on hover
...
cards.forEach((card,i) => {
  ...
  if (i === 1 || i === 3) {
    xEnd = xEnd - Math.sign(xEnd) * pullIn;
  }
